...
I have prepared an unofficial community preview build for evaluating generic WMS/WMTS online background maps in OpenOrienteering Mapper, together with LKS-2020 / Latvia TM (EPSG:10306) support.
...
This preview also adds an LKS-2020 / Latvia TM (EPSG:10306) CRS preset and packages the Latvian LKS-92 to LKS-2020 transformation grid so that Latvian projects can be tested offline with the same preview build.
...
- LKS-2020 / EPSG:10306 CRS behaviour;
...
Test reports with OS, service URL, selected layer, map CRS, service CRS/tile matrix set, whether EPSG:10306 was used, expected result and actual result would be especially useful.
